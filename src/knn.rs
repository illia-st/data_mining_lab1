...
impl KNNClassifier {
    ...
    pub fn predict_one(&self, x: &Vec<f64>) -> String {
        ...
        // 2. Знайти k найближчих (відсортуємо за відстанню)
        ...
        // 3. Підрахувати голоси класів серед k найближчих
        ...
        // 4. Знайти клас з максимумом голосів
